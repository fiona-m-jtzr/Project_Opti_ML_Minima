...
# Selon comment le modèle a été sauvegardé :
best_model0.load_state_dict(checkpoint)           # si c'est juste le state_dict
# ou
#best_model0.load_state_dict(checkpoint["model"])
...
def plot_single_model_landscape(model_class, trained_model, test_loader, 
                                criterion, device, grid_size=15, range_val=1.0, save_name='model'):
    """
